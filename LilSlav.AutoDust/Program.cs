	...
	class Program
	{
		...
		private static void Game_OnUpdate(EventArgs args)
		{
			...
			foreach (var enemy in listEnemy)
			{
				if (enemy.Modifiers.Any(
					x =>
						(
								...
								x.Name == "modifier_bounty_hunter_track" || 
								x.Name == "modifier_bloodseeker_thirst_vision" ||
								x.Name == "modifier_slardar_amplify_damage" || 
								x.Name == "modifier_item_dustofappearance"
							) ||
				...
				if ((enemy.Name == ("npc_dota_hero_templar_assassin") || 
						enemy.Name == ("npc_dota_hero_sand_king")) &&
